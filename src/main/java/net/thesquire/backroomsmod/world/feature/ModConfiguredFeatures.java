...
public class ModConfiguredFeatures {
    ...
    public static void registerConfiguredFeatures() {
        ...
        BISMUTHINITE_ORE = ConfiguredFeatures.register("bismuthinite_ore", net.minecraft.world.gen.feature.Feature.ORE, new OreFeatureConfig(OVERWORLD_BISMUTHINITE_ORES, 8, 0.2f));
